...
router.route("/")
    ...
    .post(isLoggedIn, upload.array("images"), validateCamp, catchAsync(campgrounds.createNewCampground));
...
router.route("/:id")
    ...
    .put(isLoggedIn, isAuthor, upload.array("images"), validateCamp, catchAsync(campgrounds.updateCampground))
